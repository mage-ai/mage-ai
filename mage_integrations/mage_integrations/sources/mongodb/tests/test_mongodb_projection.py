        ...
        return [
            {
                ...
                "expected_keys": [{"_id", "int_field"}, {"_id", "_sdc_deleted_at"}],
            },
            {
            ...
            },
            {
                ...
                "expected_keys": [{"_id", "string_field"}, {"_id", "_sdc_deleted_at"}],
            },
            {"projection": {"_id": 1}, "expected_keys": [{"_id"}, {"_id", "_sdc_deleted_at"}]},
            {"projection": {}, "expected_keys": [{"_id"}, {"_id", "_sdc_deleted_at"}]},
            {
                "projection": None,
                "expected_keys": [{"_id", "string_field", "int_field"}, {"_id", "_sdc_deleted_at"}],
            },
            {
                "projection": "",
                "expected_keys": [{"_id", "string_field", "int_field"}, {"_id", "_sdc_deleted_at"}],
    ...
    def run_single_projection(self, projection_mapping):
        ...
        for stream_catalog in found_catalogs:
            ...
            if projection_mapping['projection'] is not None:
                additional_md[0]['metadata']['tap_mongodb.projection'] = json.dumps(
