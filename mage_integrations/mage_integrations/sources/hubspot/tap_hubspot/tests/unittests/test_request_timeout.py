...
class TestRequestTimeoutBackoff(unittest.TestCase):
    ...
    def test_request_timeout_backoff_for_post_search_endpoint(
        self, mocked_post, mocked_get, mocked_sleep
    ):
        """
    ...
    @mock.patch('requests.post', side_effect=requests.exceptions.Timeout)
    def test_request_timeout_backoff_for_acquire_access_token_from_refresh_token(
        self, mocked_post, mocked_sleep
    ):
        """
