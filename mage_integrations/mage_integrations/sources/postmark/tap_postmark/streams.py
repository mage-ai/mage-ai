...
STREAMS: MappingProxyType = MappingProxyType(
    {
        ...
        'stats_outbound_overview': {
            ...
            'mapping': {
                ...
                'UniqueLinksClicked': {
                    'map': 'unique_linksclicked',
                    'type': int,
                    'null': False,
                },
                'WithClientRecorded': {
                    'map': 'with_client_recorded',
                    'type': int,
                    'null': False,
                },
                'WithPlatformRecorded': {
                    'map': 'with_platform_recorded',
                    'type': int,
                    'null': False,
                },
                'WithReadTimeRecorded': {
                    'map': 'with_readtime_recorded',
                    'type': int,
                    'null': False,
                },
                'WithLinkTracking': {
                    'map': 'with_linktracking',
                    'type': int,
                    'null': False,
                },
                'WithOpenTracking': {
                    'map': 'with_opentracking',
                    'type': int,
                    'null': False,
                },
                'TotalTrackedLinksSent': {
                    'map': 'total_tracked_links_sent',
                    'type': int,
                    'null': False,
                },
            },
