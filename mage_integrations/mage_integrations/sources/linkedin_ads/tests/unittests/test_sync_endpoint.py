...
class TestSyncEndpoint(unittest.TestCase):
    ...
    def test_sync_endpoint_for_reference_organization_id_is_None(
        self,
        mock_write_schema,
        ...
        static_params = {
            ...
            'owner': 'urn:li:organization:20111635',
        }
        bookmark_field = 'last_modified_time'
        id_fields = ['content_reference']
        parent = None
        ...
        mock_client.return_value = {
            'paging': {'start': 0, 'count': 100, 'links': [], 'total': 1},
            'elements': [
                {
                    'owner': 'urn:li:organization:22222222',
                    'changeAuditStamps': {
                        'created': {'time': 1564585620000},
                        'lastModified': {'time': 1564585620000},
                    },
                    'contentReference': '111111111',
                    'name': 'Stitch Tableau',
                    'type': 'VIDEO',
                    'account': 'urn:li:sponsoredAccount:111111111',
                    'status': 'ACTIVE',
