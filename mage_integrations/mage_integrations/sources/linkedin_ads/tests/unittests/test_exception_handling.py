...
class TestExceptionHandling(unittest.TestCase):
    ...
    def test_401_error_custom_message(self, mocked_access_token, mocked_request):
        ...
        try:
            ...
            self.assertEquals(
                str(e), "HTTP-error-code: 401, Error: Invalid authorization credentials."
            )
    ...
    def test_400_error_response_message(self, mocked_access_token, mocked_request):
        ...
        try:
            ...
            self.assertEquals(
                str(e), "HTTP-error-code: 400, Error: {}".format(response_json.get('message'))
            )
    ...
    def test_401_error_response_message(self, mocked_access_token, mocked_request):
        ...
        try:
            ...
            self.assertEquals(
                str(e), "HTTP-error-code: 401, Error: {}".format(response_json.get('message'))
            )
    ...
    def test_403_error_response_message(self, mocked_access_token, mocked_request):
        ...
        try:
            ...
            self.assertEquals(
                str(e), "HTTP-error-code: 403, Error: {}".format(response_json.get('message'))
            )

    def test_404_error_response_message(self, mocked_access_token, mocked_request):
        response_json = {"message": "Not Found.", "status": 404, "code": "NOT_FOUND"}
    ...
    def test_405_error_response_message(self, mocked_access_token, mocked_request):
        ...
        try:
            ...
            self.assertEquals(
                str(e), "HTTP-error-code: 405, Error: {}".format(response_json.get('message'))
            )
    ...
    def test_411_error_response_message(self, mocked_access_token, mocked_request):
        ...
        try:
            ...
            self.assertEquals(
                str(e), "HTTP-error-code: 411, Error: {}".format(response_json.get('message'))
            )

    @mock.patch("tap_linkedin_ads.client.LOGGER.error")
    def test_401_error_expired_access_token(
        self, mocked_logger, mocked_access_token, mocked_request
    ):
        response_json = {
...
class TestAccessToken(unittest.TestCase):
    ...
    def test_500_error_custom_message(self, mocked_sleep, mocked_request):
        ...
        try:
            ...
            self.assertEquals(
                str(e), "HTTP-error-code: 500, Error: An error has occurred at LinkedIn's end."
            )
    ...
    def test_429_error_response_message(self, mocked_request):
        ...
        try:
            ...
            self.assertEquals(
                str(e), "HTTP-error-code: 429, Error: {}".format(response_json.get('message'))
            )
    ...
    def test_500_error_response_message(self, mocked_sleep, mocked_request):
        ...
        try:
            ...
            self.assertEquals(
                str(e), "HTTP-error-code: 500, Error: {}".format(response_json.get('message'))
            )
        self.assertEquals(mocked_request.call_count, 5)
    ...
    def test_504_error_response_message(self, mocked_sleep, mocked_request):
        ...
        try:
            ...
            self.assertEquals(
                str(e), "HTTP-error-code: 504, Error: {}".format(response_json.get('message'))
            )
        self.assertEquals(mocked_request.call_count, 5)
