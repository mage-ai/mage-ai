...
class ZendeskTest(unittest.TestCase):
    ...
    def get_properties(self, original: bool = True):
        return_value = {
            ...
            "marketplace_organization_id": int(os.getenv("TAP_ZENDESK_MARKETPLACE_ORGANIZATION_ID"))
            or 0,
    ...
    def expected_metadata(self):
        return {
            ...
            "ticket_comments": {
                ...
                # But it does not save its own bookmark. It fetches records based on the record of
                # the parent stream.
    ...
    def is_ssl_handshake_error(self, exit_status):
        """Return True if the exit_status matches our expectations for a known
        SSL error.
    ...
    # BUG_TDL-19985
    @backoff.on_exception(backoff.expo, RetryableTapError, max_tries=2, factor=30)
    def run_and_verify_sync(self, conn_id, state=None):
        ...
        try:
            ...
            if self.is_ssl_handshake_error(exit_status):
                LOGGER.info(
                    "*******************RETRYING SYNC DUE TO TIMEOUT ERROR*******************"
                )
    ...
    def calculated_states_by_stream(self, current_state):
        timedelta_by_stream = {
            stream: [0, 2, 1]  # {stream_name: [days, hours, minutes], ...}
