...
class TestDiscovery(unittest.TestCase):
    ...
    @patch(
        'tap_zendesk.streams.Organizations.check_access',
        side_effect=zenpy.lib.exception.APIException(ACCSESS_TOKEN_ERROR),
    )
    @patch(
        'tap_zendesk.streams.Users.check_access',
        side_effect=zenpy.lib.exception.APIException(ACCSESS_TOKEN_ERROR),
    )
    @patch(
        'tap_zendesk.streams.TicketForms.check_access',
        side_effect=zenpy.lib.exception.APIException(ACCSESS_TOKEN_ERROR),
    )
    @patch(
        'tap_zendesk.streams.SLAPolicies.check_access',
        side_effect=[mocked_get(status_code=200, json={"key1": "val1"})],
    )
    ...
    @patch(
        ...
        side_effect=[
            mocked_get(
                status_code=200, json={"tickets": [{"id": "t1"}]}
            ),  # Response of the 1st get request call
            mocked_get(
                status_code=403, json={"key1": "val1"}
            ),  # Response of the 2nd get request call
            mocked_get(
                status_code=403, json={"key1": "val1"}
            ),  # Response of the 3rd get request call
            mocked_get(
                status_code=403, json={"key1": "val1"}
            ),  # Response of the 4th get request call
            mocked_get(
                status_code=403, json={"key1": "val1"}
            ),  # Response of the 5th get request call
            mocked_get(
                status_code=403, json={"key1": "val1"}
            ),  # Response of the 6th get request call
            mocked_get(
                status_code=403, json={"key1": "val1"}
            ),  # Response of the 7th get request call
            mocked_get(
                status_code=403, json={"key1": "val1"}
            ),  # Response of the 8th get request call
            mocked_get(
                status_code=403, json={"key1": "val1"}
            ),  # Response of the 9th get request call
            mocked_get(
                status_code=403, json={"key1": "val1"}
            ),  # Response of the 10th get request call
        ],
    )
    def test_discovery_handles_403__raise_tap_zendesk_forbidden_error(
        ...
        mock_logger.assert_called_with(
            "The account credentials supplied do not have 'read' access to the following stream(s): "
    ...
    @patch(
        'tap_zendesk.streams.Organizations.check_access',
        side_effect=zenpy.lib.exception.APIException(API_TOKEN_ERROR),
    )
    @patch(
        'tap_zendesk.streams.Users.check_access',
        side_effect=zenpy.lib.exception.APIException(API_TOKEN_ERROR),
    ...
    @patch(
        ...
        side_effect=[
            ...
            mocked_get(
                status_code=404, json={"key1": "val1"}
            ),  # Response of the 3rd get request call
            mocked_get(
                status_code=404, json={"key1": "val1"}
            ),  # Response of the 4th get request call
    ...
    @patch(
        ...
        side_effect=[
            ...
            mocked_get(
                status_code=400, json={"key1": "val1"}
            ),  # Response of the 4th get request call
            mocked_get(
                status_code=403, json={"key1": "val1"}
            ),  # Response of the 5th get request call
    ...
    @patch(
        'tap_zendesk.streams.Organizations.check_access',
        side_effect=zenpy.lib.exception.APIException(AUTH_ERROR),
    )
    @patch(
        'tap_zendesk.streams.Users.check_access',
        side_effect=zenpy.lib.exception.APIException(AUTH_ERROR),
    ...
    @patch(
        ...
        side_effect=[
            ...
            mocked_get(
                status_code=200, json={"key1": "val1"}
            ),  # Response of the 1st get request call
            mocked_get(
                status_code=200, json={"key1": "val1"}
            ),  # Response of the 1st get request call
