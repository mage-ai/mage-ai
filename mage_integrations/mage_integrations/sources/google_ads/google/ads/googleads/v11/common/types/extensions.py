...
from google.ads.googleads.v11.enums.types import app_store as gage_app_store
...
class AppFeedItem(proto.Message):
    ...
    Attributes:
        ...
        app_store (google.ads.googleads.v11.enums.types.AppStoreEnum.AppStore):
...
class PriceFeedItem(proto.Message):
    ...
    Attributes:
        ...
        price_offerings (Sequence[google.ads.googleads.v11.common.types.PriceOffer]):
