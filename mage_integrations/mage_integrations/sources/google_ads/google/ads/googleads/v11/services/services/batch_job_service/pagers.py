...
class ListBatchJobResultsPager:
    ...
    :class:`google.ads.googleads.v11.services.types.ListBatchJobResultsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v11.services.types.ListBatchJobResultsResponse`
    ...
    def __init__(
        ...
        Args:
            ...
            request (:class:`google.ads.googleads.v11.services.types.ListBatchJobResultsRequest`):
                The initial request object.
            response (:class:`google.ads.googleads.v11.services.types.ListBatchJobResultsResponse`):
