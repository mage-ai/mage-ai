...
class SearchGoogleAdsFieldsPager:
    ...
    :class:`google.ads.googleads.v11.services.types.SearchGoogleAdsFieldsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v11.services.types.SearchGoogleAdsFieldsResponse`
    ...
    def __init__(
        ...
        Args:
            ...
            request (:class:`google.ads.googleads.v11.services.types.SearchGoogleAdsFieldsRequest`):
                The initial request object.
            response (:class:`google.ads.googleads.v11.services.types.SearchGoogleAdsFieldsResponse`):
