...
from google.ads.googleads.v11.resources.types import campaign_conversion_goal
...
class MutateCampaignConversionGoalsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v11.services.types.CampaignConversionGoalOperation]):
...
class CampaignConversionGoalOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v11.resources.types.CampaignConversionGoal):
...
class MutateCampaignConversionGoalsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v11.services.types.MutateCampaignConversionGoalResult]):
