...
class CustomConversionGoalServiceClient(
    ...
    def mutate_custom_conversion_goals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateCustomConversionGoalsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v11.services.types.CustomConversionGoalOperation]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateCustomConversionGoalsResponse:
