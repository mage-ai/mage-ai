...
from google.ads.googleads.v11.enums.types import campaign_shared_set_status
...
class CampaignSharedSet(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v11.enums.types.CampaignSharedSetStatusEnum.CampaignSharedSetStatus):
