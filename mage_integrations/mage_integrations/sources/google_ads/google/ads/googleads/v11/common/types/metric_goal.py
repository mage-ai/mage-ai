...
from google.ads.googleads.v11.enums.types import experiment_metric
from google.ads.googleads.v11.enums.types import experiment_metric_direction
...
class MetricGoal(proto.Message):
    ...
    Attributes:
        metric (google.ads.googleads.v11.enums.types.ExperimentMetricEnum.ExperimentMetric):
            The metric of the goal. For example, clicks,
            impressions, cost, conversions, etc.
        direction (google.ads.googleads.v11.enums.types.ExperimentMetricDirectionEnum.ExperimentMetricDirection):
