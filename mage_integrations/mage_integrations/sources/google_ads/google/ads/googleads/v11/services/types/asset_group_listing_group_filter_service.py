...
class MutateAssetGroupListingGroupFiltersRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v11.services.types.AssetGroupListingGroupFilterOperation]):
...
class AssetGroupListingGroupFilterOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v11.resources.types.AssetGroupListingGroupFilter):
            Create operation: No resource name is
            expected for the new asset group listing group
            filter.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v11.resources.types.AssetGroupListingGroupFilter):
...
class MutateAssetGroupListingGroupFiltersResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v11.services.types.MutateAssetGroupListingGroupFilterResult]):
