...
class AudienceDimension(proto.Message):
    ...
    Attributes:
        age (google.ads.googleads.v11.common.types.AgeDimension):
            Dimension specifying users by their age.

            This field is a member of `oneof`_ ``dimension``.
        gender (google.ads.googleads.v11.common.types.GenderDimension):
            Dimension specifying users by their gender.

            This field is a member of `oneof`_ ``dimension``.
        household_income (google.ads.googleads.v11.common.types.HouseholdIncomeDimension):
            Dimension specifying users by their household
            income.

            This field is a member of `oneof`_ ``dimension``.
        parental_status (google.ads.googleads.v11.common.types.ParentalStatusDimension):
            Dimension specifying users by their parental
            status.

            This field is a member of `oneof`_ ``dimension``.
        audience_segments (google.ads.googleads.v11.common.types.AudienceSegmentDimension):
...
class AudienceExclusionDimension(proto.Message):
    ...
    Attributes:
        exclusions (Sequence[google.ads.googleads.v11.common.types.ExclusionSegment]):
...
class ExclusionSegment(proto.Message):
    ...
    Attributes:
        user_list (google.ads.googleads.v11.common.types.UserListSegment):
...
class AgeDimension(proto.Message):
    ...
    Attributes:
        age_ranges (Sequence[google.ads.googleads.v11.common.types.AgeSegment]):
...
class GenderDimension(proto.Message):
    ...
    Attributes:
        genders (Sequence[google.ads.googleads.v11.enums.types.GenderTypeEnum.GenderType]):
...
class HouseholdIncomeDimension(proto.Message):
    ...
    Attributes:
        income_ranges (Sequence[google.ads.googleads.v11.enums.types.IncomeRangeTypeEnum.IncomeRangeType]):
...
class ParentalStatusDimension(proto.Message):
    ...
    Attributes:
        parental_statuses (Sequence[google.ads.googleads.v11.enums.types.ParentalStatusTypeEnum.ParentalStatusType]):
...
class AudienceSegmentDimension(proto.Message):
    ...
    Attributes:
        segments (Sequence[google.ads.googleads.v11.common.types.AudienceSegment]):
...
class AudienceSegment(proto.Message):
    ...
    Attributes:
        user_list (google.ads.googleads.v11.common.types.UserListSegment):
            ...
            This field is a member of `oneof`_ ``segment``.
        user_interest (google.ads.googleads.v11.common.types.UserInterestSegment):
            Affinity or In-market segment.

            This field is a member of `oneof`_ ``segment``.
        life_event (google.ads.googleads.v11.common.types.LifeEventSegment):
            Live-event audience segment.

            This field is a member of `oneof`_ ``segment``.
        detailed_demographic (google.ads.googleads.v11.common.types.DetailedDemographicSegment):
            Detailed demographic segment.

            This field is a member of `oneof`_ ``segment``.
        custom_audience (google.ads.googleads.v11.common.types.CustomAudienceSegment):
