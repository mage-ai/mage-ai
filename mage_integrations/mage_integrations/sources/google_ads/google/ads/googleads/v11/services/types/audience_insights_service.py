...
class GenerateAudienceCompositionInsightsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer.
        audience (google.ads.googleads.v11.services.types.InsightsAudience):
...
class GenerateAudienceCompositionInsightsResponse(proto.Message):
    ...
    Attributes:
        sections (Sequence[google.ads.googleads.v11.services.types.AudienceCompositionSection]):
...
class AudienceInsightsAttribute(proto.Message):
    ...
    Attributes:
        ...
        category (google.ads.googleads.v11.services.types.AudienceInsightsCategory):
            ...
            This field is a member of `oneof`_ ``attribute``.
        dynamic_lineup (google.ads.googleads.v11.services.types.AudienceInsightsDynamicLineup):
...
class AudienceInsightsAttributeMetadata(proto.Message):
    ...
    Attributes:
        ...
        youtube_channel_metadata (google.ads.googleads.v11.services.types.YouTubeChannelAttributeMetadata):
            Special metadata for a YouTube channel.

            This field is a member of `oneof`_ ``dimension_metadata``.
        dynamic_attribute_metadata (google.ads.googleads.v11.services.types.DynamicLineupAttributeMetadata):
...
class DynamicLineupAttributeMetadata(proto.Message):
    ...
    Attributes:
        inventory_country (google.ads.googleads.v11.common.types.LocationInfo):
...
class InsightsAudience(proto.Message):
    ...
    Attributes:
        country_locations (Sequence[google.ads.googleads.v11.common.types.LocationInfo]):
        ...
        parental_status (google.ads.googleads.v11.common.types.ParentalStatusInfo):
            ...
            status.
        income_ranges (Sequence[google.ads.googleads.v11.common.types.IncomeRangeInfo]):
            Household income percentile ranges for the
            audience.  If absent, the audience does not
            restrict by household income range.
        dynamic_lineups (Sequence[google.ads.googleads.v11.services.types.AudienceInsightsDynamicLineup]):
            Dynamic lineups representing the YouTube
            content viewed by the audience.
        topic_audience_combinations (Sequence[google.ads.googleads.v11.services.types.InsightsAudienceAttributeGroup]):
...
class InsightsAudienceAttributeGroup(proto.Message):
    ...
    Attributes:
        attributes (Sequence[google.ads.googleads.v11.services.types.AudienceInsightsAttribute]):
...
class AudienceCompositionSection(proto.Message):
    ...
    Attributes:
        ...
        top_attributes (Sequence[google.ads.googleads.v11.services.types.AudienceCompositionAttribute]):
        ...
        clustered_attributes (Sequence[google.ads.googleads.v11.services.types.AudienceCompositionAttributeCluster]):
...
class AudienceCompositionAttributeCluster(proto.Message):
    ...
    Attributes:
        ...
        cluster_metrics (google.ads.googleads.v11.services.types.AudienceCompositionMetrics):
            ...
            field is unset.
        attributes (Sequence[google.ads.googleads.v11.services.types.AudienceCompositionAttribute]):
...
class AudienceCompositionAttribute(proto.Message):
    ...
    Attributes:
        attribute_metadata (google.ads.googleads.v11.services.types.AudienceInsightsAttributeMetadata):
            The attribute with its metadata.
        metrics (google.ads.googleads.v11.services.types.AudienceCompositionMetrics):
