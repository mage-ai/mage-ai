...
class SuggestGeoTargetConstantsRequest(proto.Message):
    ...
    Attributes:
        ...
        location_names (google.ads.googleads.v11.services.types.SuggestGeoTargetConstantsRequest.LocationNames):
            The location names to search by. At most 25
            names can be set.

            This field is a member of `oneof`_ ``query``.
        geo_targets (google.ads.googleads.v11.services.types.SuggestGeoTargetConstantsRequest.GeoTargets):
...
class SuggestGeoTargetConstantsResponse(proto.Message):
    ...
    Attributes:
        geo_target_constant_suggestions (Sequence[google.ads.googleads.v11.services.types.GeoTargetConstantSuggestion]):
...
class GeoTargetConstantSuggestion(proto.Message):
    ...
    Attributes:
        ...
        geo_target_constant_parents (Sequence[google.ads.googleads.v11.resources.types.GeoTargetConstant]):
