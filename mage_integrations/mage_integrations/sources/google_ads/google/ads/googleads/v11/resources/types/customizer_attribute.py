...
from google.ads.googleads.v11.enums.types import customizer_attribute_status
from google.ads.googleads.v11.enums.types import customizer_attribute_type
...
class CustomizerAttribute(proto.Message):
    ...
    Attributes:
        ...
        name (str):
            ...
            (case insensitive).
        type_ (google.ads.googleads.v11.enums.types.CustomizerAttributeTypeEnum.CustomizerAttributeType):
            Immutable. The type of the customizer
            attribute.
        status (google.ads.googleads.v11.enums.types.CustomizerAttributeStatusEnum.CustomizerAttributeStatus):
