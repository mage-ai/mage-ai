...
class AdGroupLabelServiceClient(metaclass=AdGroupLabelServiceClientMeta):
    ...
    def mutate_ad_group_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateAdGroupLabelsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateAdGroupLabelsResponse:
