...
from google.ads.googleads.v11.resources.types import customer_conversion_goal
...
class MutateCustomerConversionGoalsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v11.services.types.CustomerConversionGoalOperation]):
...
class CustomerConversionGoalOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v11.resources.types.CustomerConversionGoal):
...
class MutateCustomerConversionGoalsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v11.services.types.MutateCustomerConversionGoalResult]):
