...
class AdParameterServiceClient(metaclass=AdParameterServiceClientMeta):
    ...
    def mutate_ad_parameters(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateAdParametersRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateAdParametersResponse:
