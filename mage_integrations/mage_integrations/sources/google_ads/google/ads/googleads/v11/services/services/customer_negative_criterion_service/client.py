...
class CustomerNegativeCriterionServiceClient(
    ...
    def mutate_customer_negative_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateCustomerNegativeCriteriaRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateCustomerNegativeCriteriaResponse:
