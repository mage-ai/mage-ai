...
from google.ads.googleads.v11.resources.types import asset_group_asset
...
class MutateAssetGroupAssetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v11.services.types.AssetGroupAssetOperation]):
...
class AssetGroupAssetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v11.resources.types.AssetGroupAsset):
            Create operation: No resource name is
            expected for the new asset group asset

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v11.resources.types.AssetGroupAsset):
...
class MutateAssetGroupAssetsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v11.services.types.MutateAssetGroupAssetResult]):
