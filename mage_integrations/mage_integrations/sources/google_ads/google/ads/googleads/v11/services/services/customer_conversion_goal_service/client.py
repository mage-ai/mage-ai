...
class CustomerConversionGoalServiceClient(
    ...
    def mutate_customer_conversion_goals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateCustomerConversionGoalsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateCustomerConversionGoalsResponse:
