...
class CustomerUserAccessInvitationOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v11.resources.types.CustomerUserAccessInvitation):
...
class MutateCustomerUserAccessInvitationResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v11.services.types.MutateCustomerUserAccessInvitationResult):
