...
class CustomizerAttributeServiceClient(
    ...
    def mutate_customizer_attributes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateCustomizerAttributesRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateCustomizerAttributesResponse:
