...
class GenerateKeywordIdeasPager:
    ...
    :class:`google.ads.googleads.v11.services.types.GenerateKeywordIdeaResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v11.services.types.GenerateKeywordIdeaResponse`
    ...
    def __init__(
        ...
        Args:
            ...
            request (:class:`google.ads.googleads.v11.services.types.GenerateKeywordIdeasRequest`):
                The initial request object.
            response (:class:`google.ads.googleads.v11.services.types.GenerateKeywordIdeaResponse`):
