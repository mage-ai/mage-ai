...
class ListExperimentAsyncErrorsPager:
    ...
    :class:`google.ads.googleads.v11.services.types.ListExperimentAsyncErrorsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v11.services.types.ListExperimentAsyncErrorsResponse`
    ...
    def __init__(
        ...
        Args:
            ...
            request (:class:`google.ads.googleads.v11.services.types.ListExperimentAsyncErrorsRequest`):
                The initial request object.
            response (:class:`google.ads.googleads.v11.services.types.ListExperimentAsyncErrorsResponse`):
