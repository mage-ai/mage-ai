...
from google.ads.googleads.v11.enums.types import media_type
...
class MediaFile(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v11.enums.types.MediaTypeEnum.MediaType):
        ...
        image (google.ads.googleads.v11.resources.types.MediaImage):
            Immutable. Encapsulates an Image.

            This field is a member of `oneof`_ ``mediatype``.
        media_bundle (google.ads.googleads.v11.resources.types.MediaBundle):
            Immutable. A ZIP archive media the content of
            which contains HTML5 assets.

            This field is a member of `oneof`_ ``mediatype``.
        audio (google.ads.googleads.v11.resources.types.MediaAudio):
            Output only. Encapsulates an Audio.

            This field is a member of `oneof`_ ``mediatype``.
        video (google.ads.googleads.v11.resources.types.MediaVideo):
