...
class CampaignAssetServiceClient(metaclass=CampaignAssetServiceClientMeta):
    ...
    def mutate_campaign_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateCampaignAssetsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateCampaignAssetsResponse:
