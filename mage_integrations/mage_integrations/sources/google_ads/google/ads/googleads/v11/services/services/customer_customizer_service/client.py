...
class CustomerCustomizerServiceClient(
    ...
    def mutate_customer_customizers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateCustomerCustomizersRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateCustomerCustomizersResponse:
