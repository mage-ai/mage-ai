...
from google.ads.googleads.v11.enums.types import asset_set_link_status
...
class CampaignAssetSet(proto.Message):
    ...
    Attributes:
        ...
        asset_set (str):
            ...
            the campaign.
        status (google.ads.googleads.v11.enums.types.AssetSetLinkStatusEnum.AssetSetLinkStatus):
