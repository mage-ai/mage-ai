...
class SmartCampaignSettingServiceClient(
    ...
    def mutate_smart_campaign_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateSmartCampaignSettingsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateSmartCampaignSettingsResponse:
