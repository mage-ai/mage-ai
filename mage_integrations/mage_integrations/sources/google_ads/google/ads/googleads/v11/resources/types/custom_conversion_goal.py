...
from google.ads.googleads.v11.enums.types import custom_conversion_goal_status
...
class CustomConversionGoal(proto.Message):
    ...
    Attributes:
        ...
        conversion_actions (Sequence[str]):
            ...
            goal makes biddable.
        status (google.ads.googleads.v11.enums.types.CustomConversionGoalStatusEnum.CustomConversionGoalStatus):
