...
class ConversionGoalCampaignConfigServiceClient(
    ...
    def mutate_conversion_goal_campaign_configs(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateConversionGoalCampaignConfigsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v11.services.types.ConversionGoalCampaignConfigOperation]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateConversionGoalCampaignConfigsResponse:
