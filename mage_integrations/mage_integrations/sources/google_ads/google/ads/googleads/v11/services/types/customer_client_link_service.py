...
from google.ads.googleads.v11.resources.types import customer_client_link
...
class MutateCustomerClientLinkRequest(proto.Message):
    ...
    [CustomerClientLinkService.MutateCustomerClientLink][google.ads.googleads.v11.services.CustomerClientLinkService.MutateCustomerClientLink].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            customer link are being modified.
        operation (google.ads.googleads.v11.services.types.CustomerClientLinkOperation):
...
class CustomerClientLinkOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v11.resources.types.CustomerClientLink):
            Create operation: No resource name is
            expected for the new link.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v11.resources.types.CustomerClientLink):
...
class MutateCustomerClientLinkResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v11.services.types.MutateCustomerClientLinkResult):
