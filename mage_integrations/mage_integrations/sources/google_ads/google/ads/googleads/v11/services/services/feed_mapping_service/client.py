...
class FeedMappingServiceClient(metaclass=FeedMappingServiceClientMeta):
    ...
    def mutate_feed_mappings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateFeedMappingsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateFeedMappingsResponse:
