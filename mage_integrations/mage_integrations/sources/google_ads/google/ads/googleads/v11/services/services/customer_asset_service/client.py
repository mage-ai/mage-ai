...
class CustomerAssetServiceClient(metaclass=CustomerAssetServiceClientMeta):
    ...
    def mutate_customer_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateCustomerAssetsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateCustomerAssetsResponse:
