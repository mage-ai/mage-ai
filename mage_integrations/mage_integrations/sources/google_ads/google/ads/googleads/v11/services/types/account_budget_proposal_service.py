...
from google.ads.googleads.v11.resources.types import account_budget_proposal
...
class AccountBudgetProposalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v11.resources.types.AccountBudgetProposal):
...
class MutateAccountBudgetProposalResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v11.services.types.MutateAccountBudgetProposalResult):
