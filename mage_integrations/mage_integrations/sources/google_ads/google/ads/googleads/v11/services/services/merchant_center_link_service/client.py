...
class MerchantCenterLinkServiceClient(
    ...
    def list_merchant_center_links(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.ListMerchantCenterLinksRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.ListMerchantCenterLinksResponse:
    ...
    def get_merchant_center_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.GetMerchantCenterLinkRequest, dict]):
                The request object. Request message for
                [MerchantCenterLinkService.GetMerchantCenterLink][google.ads.googleads.v11.services.MerchantCenterLinkService.GetMerchantCenterLink].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v11.resources.types.MerchantCenterLink:
    ...
    def mutate_merchant_center_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateMerchantCenterLinkRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (google.ads.googleads.v11.services.types.MerchantCenterLinkOperation):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateMerchantCenterLinkResponse:
