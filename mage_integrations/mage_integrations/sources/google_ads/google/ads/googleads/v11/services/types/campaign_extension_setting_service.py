...
class MutateCampaignExtensionSettingsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v11.services.types.CampaignExtensionSettingOperation]):
...
class CampaignExtensionSettingOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v11.resources.types.CampaignExtensionSetting):
            Create operation: No resource name is
            expected for the new campaign extension setting.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v11.resources.types.CampaignExtensionSetting):
...
class MutateCampaignExtensionSettingsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (Sequence[google.ads.googleads.v11.services.types.MutateCampaignExtensionSettingResult]):
