...
from google.ads.googleads.v11.services.types import invoice_service
...
class InvoiceServiceClient(metaclass=InvoiceServiceClientMeta):
    ...
    def list_invoices(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.ListInvoicesRequest, dict]):
            ...
            issue_year (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            issue_month (google.ads.googleads.v11.enums.types.MonthOfYearEnum.MonthOfYear):
        ...
        Returns:
            google.ads.googleads.v11.services.types.ListInvoicesResponse:
                Response message for
                [InvoiceService.ListInvoices][google.ads.googleads.v11.services.InvoiceService.ListInvoices].
