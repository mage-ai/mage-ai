...
from google.ads.googleads.v11.enums.types import asset_set_asset_status
...
class AssetSetAsset(proto.Message):
    ...
    Attributes:
        ...
        asset (str):
            ...
            asset is linking to.
        status (google.ads.googleads.v11.enums.types.AssetSetAssetStatusEnum.AssetSetAssetStatus):
