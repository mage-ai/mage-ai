...
class AdGroupAdLabelServiceClient(metaclass=AdGroupAdLabelServiceClientMeta):
    ...
    def mutate_ad_group_ad_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateAdGroupAdLabelsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateAdGroupAdLabelsResponse:
