...
class AudienceInsightsServiceClient(
    ...
    def generate_audience_composition_insights(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.GenerateAudienceCompositionInsightsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v11.services.types.GenerateAudienceCompositionInsightsResponse:
                Response message for
                   [AudienceInsightsService.GenerateAudienceCompositionInsights][google.ads.googleads.v11.services.AudienceInsightsService.GenerateAudienceCompositionInsights].
