...
from google.ads.googleads.v11.enums.types import feed_link_status
...
class CampaignFeed(proto.Message):
    ...
    Attributes:
        ...
        placeholder_types (Sequence[google.ads.googleads.v11.enums.types.PlaceholderTypeEnum.PlaceholderType]):
            Indicates which placeholder types the feed
            may populate under the connected campaign.
            Required.
        matching_function (google.ads.googleads.v11.common.types.MatchingFunction):
        ...
        status (google.ads.googleads.v11.enums.types.FeedLinkStatusEnum.FeedLinkStatus):
