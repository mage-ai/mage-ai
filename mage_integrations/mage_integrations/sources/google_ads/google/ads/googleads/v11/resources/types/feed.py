...
from google.ads.googleads.v11.enums.types import feed_attribute_type
from google.ads.googleads.v11.enums.types import feed_origin
from google.ads.googleads.v11.enums.types import feed_status
...
class Feed(proto.Message):
    ...
    Attributes:
        ...
        attributes (Sequence[google.ads.googleads.v11.resources.types.FeedAttribute]):
            ...
            attributes.
        attribute_operations (Sequence[google.ads.googleads.v11.resources.types.FeedAttributeOperation]):
            The list of operations changing the feed
            attributes. Attributes can only be added, not
            removed.
        origin (google.ads.googleads.v11.enums.types.FeedOriginEnum.FeedOrigin):
            Immutable. Specifies who manages the
            FeedAttributes for the Feed.
        status (google.ads.googleads.v11.enums.types.FeedStatusEnum.FeedStatus):
            Output only. Status of the feed.
            This field is read-only.
        places_location_feed_data (google.ads.googleads.v11.resources.types.Feed.PlacesLocationFeedData):
        ...
        affiliate_location_feed_data (google.ads.googleads.v11.resources.types.Feed.AffiliateLocationFeedData):
    ...
    class PlacesLocationFeedData(proto.Message):
        ...
        Attributes:
            oauth_info (google.ads.googleads.v11.resources.types.Feed.PlacesLocationFeedData.OAuthInfo):
    ...
    class AffiliateLocationFeedData(proto.Message):
        ...
        Attributes:
            ...
            relationship_type (google.ads.googleads.v11.enums.types.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType):
...
class FeedAttribute(proto.Message):
    ...
    Attributes:
        ...
        name (str):
            ...
            This field is a member of `oneof`_ ``_name``.
        type_ (google.ads.googleads.v11.enums.types.FeedAttributeTypeEnum.FeedAttributeType):
...
class FeedAttributeOperation(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v11.resources.types.FeedAttributeOperation.Operator):
            Output only. Type of list operation to
            perform.
        value (google.ads.googleads.v11.resources.types.FeedAttribute):
