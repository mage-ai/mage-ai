...
class CustomerServiceClient(metaclass=CustomerServiceClientMeta):
    ...
    def mutate_customer(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateCustomerRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v11.services.types.CustomerOperation):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateCustomerResponse:
    ...
    def list_accessible_customers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.ListAccessibleCustomersRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v11.services.types.ListAccessibleCustomersResponse:
    ...
    def create_customer_client(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.CreateCustomerClientRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            customer_client (google.ads.googleads.v11.resources.types.Customer):
        ...
        Returns:
            google.ads.googleads.v11.services.types.CreateCustomerClientResponse:
                Response message for
