...
from google.ads.googleads.v11.enums.types import advertising_channel_type
from google.ads.googleads.v11.enums.types import device
from google.ads.googleads.v11.enums.types import seasonality_event_scope
from google.ads.googleads.v11.enums.types import seasonality_event_status
...
class BiddingSeasonalityAdjustment(proto.Message):
    ...
    Attributes:
        ...
        seasonality_adjustment_id (int):
            ...
            adjustment.
        scope (google.ads.googleads.v11.enums.types.SeasonalityEventScopeEnum.SeasonalityEventScope):
            The scope of the seasonality adjustment.
        status (google.ads.googleads.v11.enums.types.SeasonalityEventStatusEnum.SeasonalityEventStatus):
        ...
        description (str):
            ...
            characters.
        devices (Sequence[google.ads.googleads.v11.enums.types.DeviceEnum.Device]):
        ...
        advertising_channel_types (Sequence[google.ads.googleads.v11.enums.types.AdvertisingChannelTypeEnum.AdvertisingChannelType]):
