...
class AssetGroupSignalServiceClient(
    ...
    def mutate_asset_group_signals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateAssetGroupSignalsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateAssetGroupSignalsResponse:
