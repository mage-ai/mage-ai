...
class AdGroupAssetServiceClient(metaclass=AdGroupAssetServiceClientMeta):
    ...
    def mutate_ad_group_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateAdGroupAssetsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateAdGroupAssetsResponse:
