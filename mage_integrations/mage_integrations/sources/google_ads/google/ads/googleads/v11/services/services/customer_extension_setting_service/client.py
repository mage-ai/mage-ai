...
class CustomerExtensionSettingServiceClient(
    ...
    def mutate_customer_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateCustomerExtensionSettingsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateCustomerExtensionSettingsResponse:
