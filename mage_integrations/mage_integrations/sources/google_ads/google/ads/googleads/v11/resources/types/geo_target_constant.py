...
from google.ads.googleads.v11.enums.types import geo_target_constant_status
...
class GeoTargetConstant(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v11.enums.types.GeoTargetConstantStatusEnum.GeoTargetConstantStatus):
