...
from google.ads.googleads.v11.enums.types import keyword_plan_forecast_interval
...
class KeywordPlan(proto.Message):
    ...
    Attributes:
        ...
        forecast_period (google.ads.googleads.v11.resources.types.KeywordPlanForecastPeriod):
...
class KeywordPlanForecastPeriod(proto.Message):
    ...
    Attributes:
        date_interval (google.ads.googleads.v11.enums.types.KeywordPlanForecastIntervalEnum.KeywordPlanForecastInterval):
