...
class CustomerLabelServiceClient(metaclass=CustomerLabelServiceClientMeta):
    ...
    def mutate_customer_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateCustomerLabelsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateCustomerLabelsResponse:
