...
class FeedItemTargetServiceClient(metaclass=FeedItemTargetServiceClientMeta):
    ...
    def mutate_feed_item_targets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateFeedItemTargetsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateFeedItemTargetsResponse:
