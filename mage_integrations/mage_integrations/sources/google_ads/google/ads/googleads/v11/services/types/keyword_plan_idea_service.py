...
from google.ads.googleads.v11.enums.types import keyword_plan_keyword_annotation
...
class GenerateKeywordIdeasRequest(proto.Message):
    ...
    Attributes:
        ...
        page_size (int):
            ...
            results.
        keyword_plan_network (google.ads.googleads.v11.enums.types.KeywordPlanNetworkEnum.KeywordPlanNetwork):
            Targeting network.
            If not set, Google Search And Partners Network
            will be used.
        keyword_annotation (Sequence[google.ads.googleads.v11.enums.types.KeywordPlanKeywordAnnotationEnum.KeywordPlanKeywordAnnotation]):
...
class GenerateKeywordIdeaResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v11.services.types.GenerateKeywordIdeaResult]):
...
class GenerateKeywordIdeaResult(proto.Message):
    ...
    Attributes:
        ...
        keyword_idea_metrics (google.ads.googleads.v11.common.types.KeywordPlanHistoricalMetrics):
            The historical metrics for the keyword.
        keyword_annotations (google.ads.googleads.v11.common.types.KeywordAnnotations):
...
class GenerateKeywordHistoricalMetricsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v11.services.types.GenerateKeywordHistoricalMetricsResult]):
...
class GenerateAdGroupThemesResponse(proto.Message):
    ...
    Attributes:
        ad_group_keyword_suggestions (Sequence[google.ads.googleads.v11.services.types.AdGroupKeywordSuggestion]):
            A list of suggested AdGroup/keyword pairings.
        unusable_ad_groups (Sequence[google.ads.googleads.v11.services.types.UnusableAdGroup]):
...
class AdGroupKeywordSuggestion(proto.Message):
    ...
    Attributes:
        ...
        suggested_match_type (google.ads.googleads.v11.enums.types.KeywordMatchTypeEnum.KeywordMatchType):
