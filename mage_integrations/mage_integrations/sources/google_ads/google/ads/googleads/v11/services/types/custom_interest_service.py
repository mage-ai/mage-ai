...
from google.ads.googleads.v11.resources.types import custom_interest
...
class MutateCustomInterestsRequest(proto.Message):
    ...
    [CustomInterestService.MutateCustomInterests][google.ads.googleads.v11.services.CustomInterestService.MutateCustomInterests].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose custom
            interests are being modified.
        operations (Sequence[google.ads.googleads.v11.services.types.CustomInterestOperation]):
...
class CustomInterestOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v11.resources.types.CustomInterest):
            Create operation: No resource name is
            expected for the new custom interest.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v11.resources.types.CustomInterest):
...
class MutateCustomInterestsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v11.services.types.MutateCustomInterestResult]):
