...
class ExperimentArmServiceClient(metaclass=ExperimentArmServiceClientMeta):
    ...
    def mutate_experiment_arms(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateExperimentArmsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateExperimentArmsResponse:
