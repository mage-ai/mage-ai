...
class FeedItemSetServiceClient(metaclass=FeedItemSetServiceClientMeta):
    ...
    def mutate_feed_item_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateFeedItemSetsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateFeedItemSetsResponse:
