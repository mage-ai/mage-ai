...
from google.ads.googleads.v11.resources.types import billing_setup
...
class BillingSetupOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v11.resources.types.BillingSetup):
...
class MutateBillingSetupResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v11.services.types.MutateBillingSetupResult):
