...
class FacebookBookmarks(FacebookBaseTest):
    ...
    def calculated_states_by_stream(self, current_state):
        ...
        value based off timedelta expectations. This ensures the subsequent
        sync will replicate at least 1 record but, fewer records than the
        previous sync.
            ...
            with self.subTest(stream=stream):
                ...
                if expected_replication_method == self.INCREMENTAL:
                    ...
                    for record in second_sync_messages:
                        ...
                        # Verify the second sync records respect the previous (simulated) bookmark
                        # value
                        ...
                        self.assertLessEqual(
                            ...
                            msg=(
                                "Second sync bookmark was set incorrectly, a record with a greater"
                    ...
                    for record in first_sync_messages:
                        ...
                        self.assertLessEqual(
                            ...
                            msg=(
                                "First sync bookmark was set incorrectly, a record with a greater"
                                " replication-key value was synced."
                            ),
                        )
