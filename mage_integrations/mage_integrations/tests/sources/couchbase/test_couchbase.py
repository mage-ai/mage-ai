...
class CouchbaseSourceTests(unittest.TestCase):
    def test_discover(self):
        ...
        with patch.object(
            source, 'build_connection', return_value=couchbase_connection
                    ...
                    "streams": [
                        {
                            ...
                            "metadata": [
                                ...
                                {
                                    "breadcrumb": ("properties", "airline"),
                                    "metadata": {"inclusion": "available"},
                                },
                                {
                                    "breadcrumb": ("properties", "airlineid"),
                                    "metadata": {"inclusion": "available"},
                                },
                                {
                                    "breadcrumb": ("properties", "destinationairport"),
                                    "metadata": {"inclusion": "available"},
                                },
                                {
                                    "breadcrumb": ("properties", "distance"),
                                    "metadata": {"inclusion": "available"},
                                },
                                {
                                    "breadcrumb": ("properties", "equipment"),
                                    "metadata": {"inclusion": "available"},
                                },
                                {
                                ...
                                {
                                    "breadcrumb": ("properties", "schedule"),
                                    "metadata": {"inclusion": "available"},
                                },
                                {
                                    "breadcrumb": ("properties", "sourceairport"),
                                    "metadata": {"inclusion": "available"},
                                },
                                {
                                    "breadcrumb": ("properties", "stops"),
                                    "metadata": {"inclusion": "available"},
                                },
                                {
                            ...
                            "schema": {
                                "properties": {
                                    "airline": {"type": ["null", "string"]},
                                    "airlineid": {"type": ["null", "string"]},
                                    "destinationairport": {"type": ["null", "string"]},
                                    "distance": {"type": ["null", "number"]},
                                    "equipment": {"type": ["null", "string"]},
                                    "id": {"type": ["null", "number"]},
                                    "schedule": {"type": ["null", "array"]},
                                    "sourceairport": {"type": ["null", "string"]},
                                    "stops": {"type": ["null", "number"]},
