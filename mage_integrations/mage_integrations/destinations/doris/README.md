...
| `port` | Port of the running database (typically 9030). | `9030` |
...
| `connection_method` | The method used to connect to Doris server, either "direct" or "ssh_tunnel". | `direct` or `ssh_tunnel` |
