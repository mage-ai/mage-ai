...
In this guide, we'll copy over our sample source to get started and build from there.
...
The [list of sources](https://github.com/mage-ai/mage-ai/blob/master/mage_ai/data_integrations/sources/constants.py) is available at `/mage_ai/data_integrations/sources/constants.py`.

Add yours to make it accessible via the UI.
