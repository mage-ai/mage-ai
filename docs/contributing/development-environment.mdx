...
<Step title="Configure your development environment">
   Configure your coding envoronment for local development: `pyenv`, pre-commit hooks, etc. Follow the instructions [here](https://github.com/mage-ai/mage-ai/blob/master/README_dev.md).
</Step>
