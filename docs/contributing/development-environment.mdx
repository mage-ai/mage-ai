...
Once you have your environment configured, you'll likely want to configure your coding envoronment— `pyenv`, etc. You can find more information about setting up your local environment for development [here](https://github.com/mage-ai/mage-ai/blob/master/README_dev.md).
