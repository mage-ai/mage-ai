...
<Step title="Open Mage">
    When developing frontend, use port 3000. If you only need to develop backend, you can use port 6789. Find these ports at [https://localhost:3000](https://localhost:3000) & [https://localhost:6789](https://localhost:6789).
</Step>
</Steps>
