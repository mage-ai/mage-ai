...
Check out this [tutorial](/getting-started/data-pipeline-management#create-trigger) on how to
...
Here is an example of a log in the [Data pipeline management](/getting-started/data-pipeline-management)
UI:
