...
<CardGroup>
  <Card
    ...
    href="/getting-started/data-pipeline-management"
  ></Card>
  <Card
    title="Notebook for building data pipelines"
    icon="notebook"
    href="/introduction/features#1-data-centric-editor"
  ></Card>
  <Card
    title="Roadmap"
    icon="map"
...
👉 See more
[**details here**](/getting-started/data-pipeline-management).
...
Read more about
[**blocks**](/design/blocks) and how they work.
