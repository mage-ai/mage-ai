...
icon: "hat-wizard"
description: "an open-source pipeline tool for transforming and integrating your data."
---
...
- **Simple developer experience**: Start developing locally with a single command
...
Stop wasting time waiting for your DAGs to finish testing. Get instant feedback from your code _every_ time you run it.
