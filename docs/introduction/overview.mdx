...
<CardGroup cols={2}>
  ...
  >
    ...
    >
      <div style={{ marginRight: 16 }}>
        <img
          src="https://github.com/mage-ai/assets/blob/main/oss/card-pro.png?raw=true"
          noZoom
        />
      </div>
  ...
  >
    ...
    >
      <div style={{ marginRight: 16 }}>
        <img
          src="https://github.com/mage-ai/assets/blob/main/oss/card-oss.png?raw=true"
          noZoom
        />
      </div>
      <div style={{ marginTop: 8 }}>
...
<Steps titleSize="h2">
  <Step title="🔨 Build">
    ...
    - **Bring your favorite tools:** Write [dbt](/guides/dbt/overview) models, use your favorite [IDE](/guides/developer-ux/code-editor), [track changes with Git](/getting-started/setting-up-git), and much much more.
  ...
  - **Collaborate on cloud**: Develop collaboratively on [cloud resources](/production/deploying-to-cloud/architecture), version control with [Git](/guides/data-sync/version-control), and [test](/development/data-validation) pipelines without waiting for an available shared staging environment.
...
| 🚰 | [Streaming](/guides/streaming)                                   | Ingest and transform real-time data.                                   |
