...
There three different ways to use Git in Mage and _four_ ways to version control your files— we'll discussing each of them. We should note that the thre ways of using Git are mutually exclusive. That means that you can only choose one of the three options. However, you can use Mage's version control functionality regardless.
