...
<AccordionGroup>
   ...
   <Accordion title="Kubernetes" icon="network-wired">
      4. Start a Kubernetes cluster locally
      ...
      5. Download and update Kubernetes config file
      ...
      6. Run Mage app in Kubernetes cluster
      ...
      7. Open http://localhost:6789 in your browser.
   </Accordion>
</AccordionGroup>
