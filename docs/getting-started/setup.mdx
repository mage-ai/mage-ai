...
<Note>If you're familiar with <a href="https://docs.docker.com/compose/">Docker Compose</a> or plan on adding or extending images (e.g. Postgres) in your project, we recommend starting from the <i>Docker compose template</i>. Otherwise, we recommend <i>Docker run</i>.</Note>
