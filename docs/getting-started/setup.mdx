...
3. **Cluster Details**:
    ...
    - Add the following environment variables prior to starting a new cluster

### Environment variables

1. **Modifying Environment Variables**:
    - You can modify the environment variables for your cluster on the cluster configuration page. After making changes, click "Apply changes" to update the settings.

We recommend adding the environment variables below to get started:
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/VFFzJFZjuAg?si=GxWtS3f-ovvfw7T1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
