...
<img noZoom src="https://github.com/mage-ai/assets/blob/main/configure-runtime-variables.png?raw=True" alt="Create Global Variables" />

### In code

You can also create or edit global variables in code by editing the pipeline
`metadata.yaml` file.

<img noZoom src="https://github.com/mage-ai/assets/blob/main/configure-variables-in-code.png?raw=True" alt="Create Global Variables in Code" />
