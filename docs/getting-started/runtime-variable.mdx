...
<Frame>
  <img 
      alt="Create Global Variables" 
      src="https://github.com/mage-ai/assets/blob/main/configure-runtime-variables.png?raw=True" 
  />
</Frame>
...
<Frame>
  <img 
      alt="Create Global Variables in Code" 
      src="https://github.com/mage-ai/assets/blob/main/configure-variables-in-code.png?raw=True" 
  />
</Frame>
