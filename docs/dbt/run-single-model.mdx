...
<img noZoom src="https://github.com/mage-ai/assets/blob/main/dbt/add-dbt-model.gif?raw=true" alt="" />
...
<img noZoom src="https://github.com/mage-ai/assets/blob/main/dbt/dbt-preview.gif?raw=true" alt="" />
