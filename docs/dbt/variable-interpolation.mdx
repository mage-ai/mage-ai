...
specific to your [pipeline](/getting-started/runtime-variable) or [project](/development/environment-variables). These variables are accessible throughout your dbt profiles, pipelines, and models, using the following syntax. 
