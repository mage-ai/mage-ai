...
1. Follow the instructions given at [Build Mage docker image with Spark environment](https://docs.mage.ai/integrations/spark-pyspark#1-build-mage-docker-image-with-spark-environment)
to build a Mage docker image with Spark.
