...
- **Secrets**: Mage supports storing [secrests](/getting-started/secrets) in the database. It's also recommended to use an external [Secret Manager](/production/deploying-to-cloud/secrets/AWS) to store secrets.
