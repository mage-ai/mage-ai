...
<img noZoom src="https://github.com/mage-ai/assets/blob/main/mage-codepipeline.png?raw=True" alt="mage-codepipeline" />

<img noZoom src="https://github.com/mage-ai/assets/blob/main/mage-codepipeline-ecr.png?raw=True" alt="mage-codepipeline-ecr" />
