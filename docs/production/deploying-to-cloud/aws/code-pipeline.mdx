...
will need to have a CodeCommit repo already set up that has your Mage repository code. You will also need
to add a `buildspec.yml` file to your repository. The `buildspec.yml` file can follow the following format:
...
![mage-codepipeline](/media/mage-codepipeline.png)

![mage-codepipeline-ecr](/media/mage-codepipeline-ecr.png)
