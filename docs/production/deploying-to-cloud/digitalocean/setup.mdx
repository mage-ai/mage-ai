...
Create ssh key with command: `ssh-keygen`. Update the value of `ssh_pub_key` to your path of public key https://github.com/mage-ai/mage-ai-terraform-templates/blob/master/digitalocean/variables.tf#L32
