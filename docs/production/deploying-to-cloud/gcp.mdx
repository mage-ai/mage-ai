---
title: "Terraform Google Cloud Platform (GCP)"
---
...
with the following values: | Mode | Match | Action | Priority | | --- | --- |
--- | --- | | Advanced mode |
`request.path.startsWith('/api/pipeline_schedules/123/pipeline_runs') && inIpRange(origin.ip, '[IP address]/32')`
| Allow | 200 |
...
[see here](https://github.com/mage-ai/mage-ai/blob/master/docs/guides/dbt/serve_docs.md).
