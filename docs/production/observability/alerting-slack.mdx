...
6. You can customize message templates in `notification_config`. Here is an example config:
    ```yaml
    notification_config:
      alert_on:
        ...
    ...
    * If you specify the `summary`, the final message will be your `summary` + the url of the pipeline run page
    * If you specify the `details`, the `details` will be used as your final message directly
