...
1. You can specify the `AZURE_HOST` URLs based on your environment:
```
AZURE_PUBLIC_CLOUD_HOST_URL="https://login.microsoftonline.com/"
AZURE_CHINA_HOST_URL="https://login.chinacloudapi.cn/"
AZURE_GERMANY_HOST_URL="https://login.microsoftonline.de/"
AZURE_GOVERNMENT_HOST_URL="https://login.microsoftonline.us/"
```
2. You can specify the `MICROSOFT_GRAPH_API_HOST` URLs based you your environment:
```
MICROSOFT_GRAPH_API_HOST="https://graph.microsoft.com/"
MICROSOFT_GRAPH_API_HOST="https://graph.chinacloudapi.cn/"
MICROSOFT_GRAPH_API_HOST="https://graph.microsoft.de/"
MICROSOFT_GRAPH_API_HOST="https://graph.microsoft.us/"
```
