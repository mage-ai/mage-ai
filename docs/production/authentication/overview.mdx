...
##  Set token period duration 

You can set the following enviroment variable to define how long the MAGE_ACCESS_TOKEN_EXPIRY_TIME should last in seconds.
Default 2592000 wich is 30 days
