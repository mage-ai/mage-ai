...
<img noZoom src="https://github.com/mage-ai/assets/blob/main/version-control/git-integration/branch-button.png?raw=true"/>
...
<AccordionGroup>
    ...
    <Accordion title="Create new branch">
        ...
        <img noZoom src="https://github.com/mage-ai/assets/blob/main/version-control/git-integration/create-new-branch.png?raw=true" width="100%"/>
    </Accordion>
    <Accordion title="Switch branch">
        ...
        <img noZoom src="https://github.com/mage-ai/assets/blob/main/version-control/git-integration/switch-branch.png?raw=true" width="100%"/>
    </Accordion>
    <Accordion title="Commit & push">
        <Steps>
            <Step title="Select files">
                ...
                <img noZoom src="https://github.com/mage-ai/assets/blob/main/version-control/git-integration/select-files.png?raw=true" width="100%"/>
            </Step>
            <Step title="Commit your changes">
                Then, enter a descriptive commit message and click `Commit`. This will commit your changes to your local git directory.

                <img noZoom src="https://github.com/mage-ai/assets/blob/main/version-control/git-integration/commit-changes.png?raw=true" width="100%"/>
            </Step>
            <Step title="Push to remote">
                ...
                <img noZoom src="https://github.com/mage-ai/assets/blob/main/version-control/git-integration/push-to-remote.png?raw=true" width="100%"/>
            </Step>
        </Steps>
    </Accordion>
