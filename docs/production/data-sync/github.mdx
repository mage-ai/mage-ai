...
If you need to connect to a GitHub Enterprise repository, you will need to first authorize
Mage to connect to your GHE host.

<Accordion title="Configure Mage to authenticate with GHE">
