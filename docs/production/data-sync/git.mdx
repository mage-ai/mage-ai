...
You can use the Mage terminal to perform your git actions. You'll still need to generate your SSH keys, and can start a
ssh-agent so that you don't have to enter your passphrase every time you perform an action.
