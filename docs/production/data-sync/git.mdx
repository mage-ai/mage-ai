...
2. Navigate to the "Git settings" section of the Mage settings page.
...
3. Set up your SSH key so that your machine can access Github, if you
haven't already. Check out this [guide](https://docs.mage.ai/developing-in-the-cloud/setting-up-git#3-set-up-ssh-key)
on how to set up your SSH key.
4. Fill out the form:
