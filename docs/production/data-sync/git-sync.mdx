...
To enable Git Sync, first [configure Git in Mage](/development/git/configure), then navigate to the settings page and tick the `Git Sync` box. To configure git settings, see [this guide](/production/data-sync/git-integration).
