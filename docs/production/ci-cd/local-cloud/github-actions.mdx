...
Mage supports GitHub Actions for CI/CD workflows. We have templates for deploying to [AWS ECS, GCP GKE, and Azure](https://github.com/mage-ai/mage-ai/tree/master/templates/github_actions).
...
Mage can be deployed to Azure using GitHub Actions. You’ll need to add these:
