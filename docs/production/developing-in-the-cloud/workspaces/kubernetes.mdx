...
Once the ingress controller is installed, you can create an ingress through the Mage Helm charts. You can create
an ingress by setting the following fields in the `values.yaml` file:
