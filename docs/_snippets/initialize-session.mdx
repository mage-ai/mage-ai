...
Before starting, first `nano ~/YOUR_SECRETS_PATH/.env.mage`, replacing `YOUR_SECRETS_PATH` with an appropriate directory, to create a new secrets file. Then add the following to your secrets file:
