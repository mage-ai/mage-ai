...
* To install WSL2 on Windows, open Command Prompt as admin and run “wsl –install.”
It will install all the WSL2 components and the default Ubuntu Linux distro.
* To view a list of available WSL distros to install on Windows, run "wsl --list --online"
* To install a specific distro, run “wsl –install -d <Distro>”.
...
```
To test out the installation, run
```
$ poetry --version
```
