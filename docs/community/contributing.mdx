...
Code for the web server is in `mage_ai/server/`. Backend server is written in Python.

### Linter
Install `flake8` in your IDE to lint the Python code.

### Unit tests
Add unit tests for the feature in [mage_ai/tests](https://github.com/mage-ai/mage-ai/tree/master/mage_ai/tests) directory
