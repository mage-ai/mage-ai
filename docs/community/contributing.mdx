...
1. [How to add a new chart type](https://github.com/mage-ai/mage-ai/blob/master/docs/contributing/charts/how_to_add.md)
2. _More coming soon..._

## Testing changes

Please read this [document](https://github.com/mage-ai/mage-ai/blob/master/docs/contributing/testing.md).
