...
Sources should be tested both in the console and via the Mage UI.

### Local testing

Follow the directions [here](https://github.com/mage-ai/mage-ai/blob/master/mage_integrations/README.md#testing-sync-locally) to configure a lightweight test of your sources taps via a bash terminal in the Mage docker instance. 
