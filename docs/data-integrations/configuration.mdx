...
read the [documentation](/production/configuring-production-settings/runtime-variable#using-runtime-variables).
...
<img
     alt="Configure data integrations"
     src="/media/integration-prefix.png"
  />
</Frame>
...
For more information on secrets, read the [documentation](/development/secrets/secrets).
