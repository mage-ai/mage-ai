...
To apply a tag, first right click the desired pipeline and select "Add/Remove tags," then, type or select the desired tags, separated by enter. Tag names are trimmed, must be non-empty, and can contain up to 70 characters.
