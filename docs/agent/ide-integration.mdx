...
description: "Connect Cursor, Claude Code, OpenAI Codex CLI, or another MCP-compatible AI client to your Mage Pro cluster via MCP."
---

import { ProOnly } from '/snippets/pro/only.mdx';

<ProOnly source="mage-agent-ide-integration" />
