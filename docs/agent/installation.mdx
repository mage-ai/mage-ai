...
<ProOnly source="mage-agent-installation" />
...
In Mage Pro, open **Settings** > **Platform** > **Mage Agent** to download the latest Mage Agent installer for Claude Code or OpenAI Codex CLI.
