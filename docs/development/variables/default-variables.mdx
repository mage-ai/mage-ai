...
sidebarTitle: "Default variables"
description: "This page lists all of the environment variables that are set by default in Mage."
---

You might chose to set your own and reference them throughout your project. Read more about accessing variables [here](development/variables/referencing-variables).
