...
<img noZoom src="https://github.com/mage-ai/assets/blob/main/create-secrets.png?raw=True" alt="Create Secrets" />
...
<img noZoom src="https://github.com/mage-ai/assets/blob/main/using-secrets.png?raw=True" alt="Using Secrets" />
