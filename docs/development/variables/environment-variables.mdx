...
| `DEFAULT_ADMIN_EMAIL`           | Default email value for the default owner user                                                                                                                  | admin@admin.com                                                          |
| `DEFAULT_ADMIN_PASSWORD`        | Default password value for the default owner user                                                                                                               | admin                                                                    |
