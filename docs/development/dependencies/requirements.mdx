...
description: "Mage allows you to easily integrate third-party Python packages into your project and pipelines. This guide will walk you through the process of adding and managing external dependencies."
---
<p align='center'>
<img
  alt="Python mecha"
...
The path to your `requirements.txt` file will typically be:
...
When installing Mage using Docker, Mage provides two main methods for automatically installing third part packages at runtime.
