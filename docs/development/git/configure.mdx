...
<img
    noZoom
    class="hero inline"
    src="https://user-images.githubusercontent.com/78053898/198753409-c7c41a8d-c137-4273-bb3b-76ecc81f8ee2.png"
/>
        ...
        **SSH keys with passphrase are not supported**
        ...
        <Steps>
            ...
            <Step title="Navigate to Git settings">
                ...
                <img noZoom src="https://github.com/mage-ai/assets/blob/main/mage-settings.png?raw=True"/>
            ...
            <Step title="Select SSH as the authentication type.">
                ...
                <img noZoom src="https://github.com/mage-ai/assets/blob/main/git-settings.png?raw=True"/>
            </Step>
