---
title: "Generate an SSH token for Git Sync"
sidebarTitle: "Generate an SSH token"
---
...
If you're using our unidirectional or bidirectional Git Sync, you'll need to configure Git with SSH or HTTPS. See the guides below for each.
...
<Steps>
   ...
   <Step title="Add SSH key to your Git provider">
      ...
      |----------|-----------------------------------------------------------------------------------------------------------------------------|
      | GitHub   | [GitHub Docs](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account) |
      | GitLab   | [GitLab Docs](https://docs.gitlab.com/ee/user/ssh.html#add-an-ssh-key-to-your-gitlab-account)                                      |
   ...
   <Step title="Test your SSH connection">
      | Provider | Instructions                                                                                                                |
      |----------|-----------------------------------------------------------------------------------------------------------------------------|
      | GitHub   | [GitHub Docs](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/testing-your-ssh-connection) |
      | GitLab   | [GitLab Docs](https://docs.gitlab.com/ee/user/ssh.html#verify-that-you-can-connect)                                      |
