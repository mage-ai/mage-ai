...
| ------------------------- | ----------------------------- | ----------------- |
| `MAGE_DATABASE_CONNECTION_URL` | Specify the database connection url for orchestration DB. Defaults to local sqlite db. | postgresql+psycopg2://user:password@host:port/dbname |
