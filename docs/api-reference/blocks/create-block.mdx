...
<ParamField query="color" type="string">
  Block color displayed by the frontend.
</ParamField>
...
<ParamField query="extension_uuid" type="string">
  UUID of extensions, currently [Great Expectations](https://docs.mage.ai/development/testing/great-expectations) is the only extension supported.
</ParamField>
