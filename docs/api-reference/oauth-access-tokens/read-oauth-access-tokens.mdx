---
title: "Read OAuth access tokens"
...
<ParamField query="show_all_users" type="integer">
  If `show_all_users` is `1`, then show OAuth access tokens for all users.

  This query parameter can only be used by an admin user.
