...
Both Mage OSS and Mage Pro share a strong foundation of core features, ensuring a consistent development experience regardless of which version you choose.
...
- **Streaming pipelines**: Real-time data processing (Pro includes stateful streaming with checkpointing)
...
| **SCIM provisioning** | ❌ | ✅ Automated user/group lifecycle from your IdP |
...
3. **Import your Mage OSS project and set up CI/CD**  
   ...
   - **Set up branch mappings** (optional):
     - `main/master` → Production
     - `staging` → Staging
     - `development` → Development
   - **Enable automatic deployments or manual approval workflows** (optional)
...
9. **Deploy to production**  
   - Use the deployment app to promote code from dev → staging → production
...
- **SCIM provisioning**: Automated user and group lifecycle management from your IdP
...
- **Community**: Join the [Mage community](https://www.mage.ai/community) for tips and best practices
