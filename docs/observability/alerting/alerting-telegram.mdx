...
After you create your Telegram bot webhook URL, you can configure alerts in the
...
3. Choose the alert outcomes, enable Telegram, enter the webhook URL, and use
