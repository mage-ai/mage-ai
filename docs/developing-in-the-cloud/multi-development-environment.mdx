...
the cloud. Use Mage’s maintained [Terraform scripts](production/using-terraform)
to deploy to cloud.
...
Your team can use
[Git for version control](/developing-in-the-cloud/setting-up-git) in the cloud.

![](/images/multi-dev-environment.jpeg)
