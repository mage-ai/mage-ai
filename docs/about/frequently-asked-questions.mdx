...
7. Modular: every block/cell you write is a standalone file that is interoparable; meaning it can be used in other pipelines or in other code bases.
...
[Here is a doc](/production/observability/alerting-slack) to help you set up alerting for pipeline status updates in Slack.

</Accordion>

<Accordion title ="How can I contribute or request features?">

We love and welcome community contributions! [Here is a doc](/community/contributing) to get you started.

To request features, add a “Feature request” using the `New issue` button in Github from this [link](https://github.com/mage-ai/mage-ai/issues), or join our [feature-request](https://mageai.slack.com/archives/C03KW780J2F) Slack channel.
