...
Kafka supports [structuring and partitioning](https://kafka-python.readthedocs.io/en/master/apidoc/KafkaProducer.html#kafka.KafkaProducer.send) your data. The kafka data loader returns these elements as dictionaries with the keys (topic, partition, offset, key, value, time), e.g.
