---
title: "Connecting a database in Docker"
sidebarTitle: "Connect a db in Docker"
icon: "docker"
description: "Here's how you can configure Mage in Docker to make the most of your data pipelines."
---
