...
<Note>
    In Mage Pro, the Git settings page is the legacy configuration workflow. For current Git configuration and deployments, use the Deploy app at `/apps/deploy`.
</Note>
