...
<img noZoom src="https://github.com/mage-ai/assets/blob/main/blocks/dynamic-block-graph.jpg?raw=true" alt="Dynamic block dependency graph" />
...
<img noZoom src="https://github.com/mage-ai/assets/blob/main/blocks/dynamic-block-runs.png?raw=true" alt="Dynamic block runs" />
