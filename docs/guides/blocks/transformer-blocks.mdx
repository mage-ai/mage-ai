...
<Frame>
  <img 
      alt="Image of transformer block template drop down highlighting 'Fill in missing values'" 
      src="https://github.com/mage-ai/assets/blob/main/blocks/transformers/transformer_actions_impute.png?raw=true" 
  />
</Frame>
...
<Frame>
  <img 
      alt="Image of transformer block template drop down highlighting 'Aggregate/Aggregate by average value'" 
      src="https://github.com/mage-ai/assets/blob/main/transformer_actions_agg.png?raw=True" 
  />
</Frame>
