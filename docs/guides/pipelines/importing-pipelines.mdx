...
Downloaded pipeline zip files include the pipeline `metadata.yaml` and source files for
regular, callback, conditional, chart, and extension blocks when those files are present
in the project.
...
<Frame>
    <p align="center">
      <img
          ...
          src="https://mage-ai.github.io/assets/pipelines/importing/pipeline-single-folder-structure.png"
      />
    </p>
</Frame>
...
<Frame>
    <p align="center">
      <img
          alt="Pipeline single folder structure"
          src="https://mage-ai.github.io/assets/pipelines/importing/pipeline-subfolder-structure.png"
      />
    </p>
</Frame>
