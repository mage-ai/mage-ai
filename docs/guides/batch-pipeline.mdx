...
![Restaurant](/images/restaurant-food.gif)
...
[this guide](use_completed_pipeline.md).
...
![Create new pipeline](/images/create-new-pipeline.gif)
...
![histogram demo](/images/histogram.gif)

Your chart should look like:

![histogram chart](/images/histogram.jpeg)
...
![bar-chart demo](/images/bar-chart.gif)

Your chart should look like:

![bar-chart chart](/images/bar-chart.jpeg)
...
![credentials](/images/credentials.gif)
