...
go to the [project settings](http://localhost:3000/settings/workspace/preferences)
and enter the OpenAI API key under the section labeled <b>OpenAI</b>.
...
<Note>
    ...
    in your [project settings](http://localhost:3000/settings/workspace/preferences).
</Note>
