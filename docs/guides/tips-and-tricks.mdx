...
<Accordion title="SQL Interpolation" icon="database">
  🌟 Feature Highlights:

  * Effortlessly interpolate variables in SQL with Jinja.
  * Select directly from dataframes: combine Pandas and SQL to get the best of both worlds!

  Read more about SQL blocks [here](/guides/blocks/sql-blocks)!
  
  <Frame>
  <iframe
    width="560"
    height="315"
    src="https://www.youtube.com/embed/x5vBMfDukLY"
    title="YouTube video player"
    frameborder="0"
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
    allowFullScreen
