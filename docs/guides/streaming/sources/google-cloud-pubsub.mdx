...
[Testing apps locally with the emulator](https://docs.mage.ai/community/contributing)
...
## Create a `topic_id` for testing

Use the procedures listed under the `Using the emulator` section to create a `topic_id`, e.g.,

```
python publisher.py my-project-id create my-topic-id
```
...
Please use the example given in the [Testing apps locally with the emulator](https://docs.mage.ai/community/contributing)
