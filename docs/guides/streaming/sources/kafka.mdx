...
offset:
  type: "timestamp"
  value: 1693396630163  # Wed Aug 30 2023 11:57:10 GMT+0
  partitions:
    - {"topic": "my_topic", "partition": 0}
```
...
The 1.5x multiplier accounts for overhead. Ensure your consumer JVM has at least this much heap memory available.
...
3. Scale horizontally: Run multiple consumer instances (different consumer groups)
