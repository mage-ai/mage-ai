...
**Step 6**: Click “Next step to deployment stage” button to move onto the next stage of the workflow.
...
Go to the Deployments application and use Mage Pro's "Connect repository" feature to link your BitBucket account through secure authentication.
