...
<Step title="Add dbt model block to pipeline">
  ...
  <Frame>
    <img 
        alt="" 
        src="https://github.com/mage-ai/assets/blob/main/dbt/add-dbt-model.gif?raw=true" 
    />
  </Frame>
</Step>
<Step title="Edit my_first_dbt_model">
    ...
    <img 
        alt="" 
        src="https://github.com/mage-ai/assets/blob/main/dbt/dbt-preview.gif?raw=true" 
    />
    </Frame> 
    ...
    <Frame>
      <img 
          alt="" 
          src="https://github.com/mage-ai/assets/blob/main/dbt/run-model.png?raw=true" 
      />
    </Frame>
