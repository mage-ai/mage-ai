...
To run this pipeline, open the pipeline's _Triggers_ page from the pipeline navigation and select _Run @once_ to trigger a pipeline run. Select the _logs_ icon to see the run in realtime!
