...
description: "In this tutorial, we’ll create a DAG in Airflow for scheduling and running a
...
3. Click on the DAG to view the detail page. The URL could typically be this:
   `http://localhost:8080/admin/airflow/tree?dag_id=mage_pipeline_etl_demo`
