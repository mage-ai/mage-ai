...
sidebarTitle: "ML training pipeline"
---
...
[this guide](https://github.com/mage-ai/mage-ai/blob/master/docs/tutorials/quick_start/train_titanic_model/use_completed_pipeline.md).
...
<img alt="requirements" src="/media/requirements.png" />
...
![Transform data](/media/transform-data.gif)
...
![Train model](/media/train-model.gif)
...
![](/media/execute-pipeline-button.png)
