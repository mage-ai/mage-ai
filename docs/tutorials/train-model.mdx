...
<img alt="requirements" src="/images/requirements.png" />
...
![Transform data](/images/transform-data.gif)
...
![Train model](/images/train-model.gif)
...
![](/images/execute-pipeline-button.png)
