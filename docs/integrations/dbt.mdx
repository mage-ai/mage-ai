...
- [Connection profiles](/integrations/connection-profiles)
- [DBT models depending on other blocks using sources](/integrations/dbt-models)
- [Running DBT tests](/integrations/running-dbt-tests)
- [Add an existing DBT project to Mage](/integrations/add-existing-dbt)
