...
default:
  trino:
    ...
    overwrite_type: path_to_types_json # Optional
```
...
1. You can optionally overwrite your table columns types by adding a JSON to `overwrite_type` config, the format needs to be {"column_name":"VARCHAR"}
