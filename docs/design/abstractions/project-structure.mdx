---
title: "Mage file directory"
description: "Details about how the Mage file directory works and how typical projects are structured."
---

## Overview

A Mage workspace lives inside it's own folder. It's there where mage data is stored (`mage_data`) and individual projects are housed. You can think of a project as an environment: it contains configurations, pipelines, and other project-specific data. A workspace can hold multiple projects.
