...
<img noZoom class="hero inline" alt="Callbacks" src="https://i.imgflip.com/3s2icl.jpg" />
...
<img noZoom src="https://github.com/mage-ai/assets/blob/main/block-callback.png?raw=True" alt="Block callback" />
