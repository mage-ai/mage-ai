...
Handles data transfer between a Azure Blob Storage bucket and the Mage app. Supports loading files of any of the following types:

-   CSV
-   JSON
-   Parquet

To authenticate with Azure, define the following environment variables in your [configuration loader](#configuration-settings):
