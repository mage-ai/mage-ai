...
Each block (except a scratchpad block) in a pipeline maps to an individual file
within a project.

Blocks can be reused and shared across multiple pipelines within the same
project.

<img className="w-80" src="/images/blocks-1.png" alt="Blocks" />
...
storage systems, see docs on [Data Loading](/design/blocks/data%5Floading).
