...
class PipelineScheduler:
    ...
    def __execute_pipeline_callbacks(
        ...
        try:
            ...
            self.pipeline.execute_pipeline_callbacks(
                ...
                global_vars=self.__build_pipeline_run_variables(),
                logger=self.logger,
                logging_tags=tags,
            )
    ...
    def __build_pipeline_run_variables(self) -> Dict:
        """Build global variables dict from the pipeline run context."""
        if self.pipeline_run:
            return self.pipeline_run.get_variables(
