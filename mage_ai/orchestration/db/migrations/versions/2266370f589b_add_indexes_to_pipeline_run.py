...
def upgrade() -> None:
    ...
    op.create_index(
        op.f('ix_pipeline_run_execution_date'), 'pipeline_run', ['execution_date'], unique=False
    )
    op.create_index(
        op.f('ix_pipeline_run_pipeline_uuid'), 'pipeline_run', ['pipeline_uuid'], unique=False
    )
