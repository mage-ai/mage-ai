    ...
    'blocks': [
      ...
      },
      {
        ...
        'error': {
          ...
          'message': 'You may have moved it or changed its filename. Delete the current block to remove it from the pipeline or write code and save the pipeline to create a new file at /home/src/default_repo/mlops/mlops/memory_upgrade_v2/transformers/child_2x.py.',
        },
        'metadata': {},
        'tags': [],
        'pipelines': [
      ...
      },
      {
        ...
        'error': {
          'error': 'No such file or directory',
          'message': 'You may have moved it or changed its filename. Delete the current block to remove it from the pipeline or write code and save the pipeline to create a new file at /home/src/default_repo/mlops/mlops/memory_upgrade_v2/transformers/child_1x_spawn_1x.py.',
        },
        'metadata': {},
        'tags': [
          'dynamic_child',
