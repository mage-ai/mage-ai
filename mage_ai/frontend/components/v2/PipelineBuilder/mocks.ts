...
const PIPELINE_DEPLOY = {
  ...
  "blocks": [
    ...
    },
    {
      ...
      "callback_blocks": [],
      "conditional_blocks": [],
      "content": "from mlops.utils.deploy.terraform.cli import terraform_destroy\n\nif 'custom' not in globals():\n    from mage_ai.data_preparation.decorators import custom\n\n\n@custom\ndef transform_custom(*args, **kwargs):\n    if kwargs.get('destroy'):\n        terraform_destroy()\n    else:\n        print('Skipping Terraform destroy...')",
      "outputs": [],
      "metadata": {},
      "tags": [],
      "pipelines": []
...
const PIPELINE_TRAINING = {
  ...
  "data_integration": null,
  "description": "Train models from the sklearn library (e.g. ExtraTreesRegressor, GradientBoostingRegressor, Lasso, LinearRegression, LinearSVR, RandomForestRegressor).",
  "executor_config": {},
  "executor_count": 1,
  "executor_type": null,
      ...
      "pipelines": [
        ...
        },
        {
          ...
          "pipeline": {
            ...
            "description": "XGBoost is a scalable and efficient implementation of gradient boosted decision trees, a powerful ensemble machine learning technique.",
