...
export const LOCAL_STORAGE_KEY_PIPELINE_TREE_HIDDEN = 'pipeline_tree_hidden';
export const LOCAL_STORAGE_KEY_PIPELINE_EXECUTION_HIDDEN = 'pipeline_execution_hidden';
export const LOCAL_STORAGE_KEY_PIPELINE_EXECUTION_OUTPUT_HEIGHT = 'pipeline_execution_output_height';
