...
export const LOCAL_STORAGE_KEY_PIPELINE_STREAMING_TREE_HIDDEN = 'pipeline_streaming_tree_hidden';
export const LOCAL_STORAGE_KEY_STREAMING_OUTPUT_HEIGHT = 'streaming_output_height';
