...
export const LOCAL_STORAGE_KEY_PIPELINE_EXECUTION_HEIGHT = 'pipeline_execution_height';
export const LOCAL_STORAGE_KEY_PIPELINE_EXECUTION_TREE_HIDDEN =
  'pipeline_execution_tree_hidden';
