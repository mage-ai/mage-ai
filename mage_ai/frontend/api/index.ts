...
export const ApiResourceType = ACTION_EXECUTE | ANALYSES | AUTOCOMPLETE_ITEMS | BACKFILLS | BLOCKS | BLOCK_LAYOUT_ITEMS | BLOCK_OUTPUTS | BLOCK_RUNS | BLOCK_TEMPLATES | BROWSER_ITEMS | CACHE_ITEMS | CLIENT_PAGES | CLUSTERS | COLUMNS | COMMAND_CENTER_ITEMS | COMPUTE_CLUSTERS | COMPUTE_CONNECTIONS | COMPUTE_SERVICES | CONFIGURATION_OPTIONS | CUSTOM_DESIGNS | CUSTOM_TEMPLATES | DATA_PROVIDERS | DOWNLOADS | EVENT_MATCHERS | EVENT_RULES | EXECUTION_STATES | EXTENSION_OPTIONS | FEATURES | FEATURE_SETS | FEATURE_SET_VERSIONS | FILES | FILE_CONTENTS | FILE_VERSIONS | FOLDERS | GIT_BRANCHES | GIT_CUSTOM_BRANCHES | GIT_FILES | GLOBAL_DATA_PRODUCTS | GLOBAL_HOOKS | INSTANCES | INTEGRATION_DESTINATIONS | INTEGRATION_SAMPLES | INTEGRATION_SOURCES | INTEGRATION_SOURCE_STREAMS | INTERACTIONS | KERNELS | LLMS | LOGS | MONITOR_STATS | OAUTHS | OUTPUTS | PAGE_BLOCK_LAYOUTS | PERMISSIONS | PIPELINES | PIPELINE_INTERACTIONS | PIPELINE_RUNS | PIPELINE_SCHEDULES | PIPELINE_TRIGGERS | PULL_REQUESTS | PROJECTS | ROLES | SEARCH_RESULTS | SECRETS | SEEDS | SESSIONS | SPARK_APPLICATIONS | SPARK_ENVIRONMENTS | SPARK_EXECUTORS | SPARK_JOBS | SPARK_SQLS | SPARK_STAGES | SPARK_STAGE_ATTEMPTS | SPARK_STAGE_ATTEMPT_TASKS | SPARK_STAGE_ATTEMPT_TASK_SUMMARYS | SPARK_THREADS | STATUSES | SYNCS | TAGS | TRANSFORMER_ACTIONS | USERS | VARIABLES | VERSIONS | VERSION_CONTROL_BRANCHES | VERSION_CONTROL_FILES | VERSION_CONTROL_PROJECTS | VERSION_CONTROL_REMOTES | WIDGETS | WORKSPACES | CODE_EXECUTIONS;
