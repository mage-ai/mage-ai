...
MAX_OUTPUT_IMAGE_PREVIEW_SIZE = int(
    os.getenv("MAX_OUTPUT_IMAGE_PREVIEW_SIZE", 1024 * 1024 * 5)
)
...
# ---------------------
CONCURRENCY_CONFIG_BLOCK_RUN_LIMIT = get_int_value(
    os.getenv("CONCURRENCY_CONFIG_BLOCK_RUN_LIMIT")
)
CONCURRENCY_CONFIG_PIPELINE_RUN_LIMIT = get_int_value(
    os.getenv("CONCURRENCY_CONFIG_PIPELINE_RUN_LIMIT")
)
DISABLE_AUTO_BROWSER_OPEN = get_bool_value(
    os.getenv("DISABLE_AUTO_BROWSER_OPEN", "False")
)
