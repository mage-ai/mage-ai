...
DYNAMIC_BLOCKS_V2 = DYNAMIC_BLOCKS_VERSION >= int(os.getenv('DYNAMIC_BLOCKS_VERSION') or 1)
MEMORY_MANAGER_VERSION = int(os.getenv('MEMORY_MANAGER_VERSION') or 1)
MEMORY_MANAGER_V2 = MEMORY_MANAGER_VERSION >= int(os.getenv('MEMORY_MANAGER_VERSION') or 1)
...
MEMORY_MANAGER_PANDAS_V2 = MEMORY_MANAGER_PANDAS_VERSION >= int(
    os.getenv('MEMORY_MANAGER_PANDAS_VERSION') or 1
)
MEMORY_MANAGER_POLARS_V2 = MEMORY_MANAGER_POLARS_VERSION >= int(
    os.getenv('MEMORY_MANAGER_POLARS_VERSION') or 1
)
