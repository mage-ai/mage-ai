...
def get_aws_region_name():
    ...
    if region_name is None:
        region_name = get_secret_value_db_safe(AWS_REGION_NAME)
    if region_name is None:
        region_name = get_secret_value_db_safe(AWS_DEFAULT_REGION)
    if region_name is None:
...
def get_aws_access_key_id():
    ...
    if aws_access_key_id is None:
        aws_access_key_id = get_secret_value_db_safe(AWS_ACCESS_KEY_ID)
...
def get_aws_secret_access_key():
    ...
    if aws_secret_access_key is None:
        aws_secret_access_key = get_secret_value_db_safe(AWS_SECRET_ACCESS_KEY)
