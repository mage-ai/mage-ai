...
class VariableManagerTest(DBTestCase):
    ...
    def test_set_and_get_global_variable(self):
        ...
        set_global_variable("test_pipeline_3", "var1", 1, self.repo_path)
        set_global_variable("test_pipeline_3", "var2", "test", self.repo_path)
        set_global_variable("test_pipeline_3", "var3", [1, 2, 3], self.repo_path)
        set_global_variable("test_pipeline_3", "var4", dict(k1="v1", k2="v2"), self.repo_path)
