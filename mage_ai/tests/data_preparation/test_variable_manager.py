...
class VariableManagerTest(DBTestCase):
    def test_add_and_get_variable(self):
        ...
        variable_manager.add_variable('block1', 'var1', data1)
        variable_manager.add_variable('block2', 'var2', data2)
    ...
    def test_get_variables_by_pipeline(self):
        ...
        variable_manager.add_variable('block1', 'var1', 1)
        variable_manager.add_variable('block1', 'var2', 2)
        variable_manager.add_variable('block2', 'var3', 3)
        variable_manager.add_variable('block2', 'var4', 4)
        self.assertEqual(
